const NanoLoanEngine = artifacts.require('./rcn/NanoLoanEngine.sol');

const Bundle = artifacts.require('./Bundle.sol');
const Poach = artifacts.require('./Poach.sol');
const PawnManager = artifacts.require('./PawnManager.sol');

const TestToken = artifacts.require('./rcn/utils/test/TestToken.sol');
const TestERC721 = artifacts.require('./rcn/utils/test/TestERC721.sol');
